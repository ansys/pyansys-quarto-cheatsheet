...
![image](./../_extensions/cheat_sheet/_static/ansys_part_of_synopsys.png)
...
You can also leverage the ``algorithm`` and ``algpseudocode`` LaTeX packages for
more advanced algorithm representation.
